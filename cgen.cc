...
// COOL编译器代码生成器实现文件
//
// 本文件实现了COOL语言的代码生成功能，将抽象语法树转换为MIPS汇编代码
//
// 主要功能模块：
// 1. 类表管理 (CgenClassTable)
// 2. 类节点管理 (CgenNode)
// 3. 常量编码 (字符串、整数、布尔值)
// 4. 表达式编码 (各种COOL表达式)
// 5. 方法和属性编码
...
// MIPS指令生成辅助函数：加载内存值到寄存器
// 生成LW指令，从内存地址(source_reg+offset*4)加载值到dest_reg
